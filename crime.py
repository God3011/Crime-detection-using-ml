...
lo_outcomes = pd.read_csv(r'F:\CMRIT-PRO\B-sec-20230505T074501Z-001\B-sec\2.FBI CRIME DETECTION USING MACHINE LEARNING\2.FBI CRIME DETECTION USING MACHINE LEARNING\Code\london-outcomes.csv')
lo_outcomes.head()
lo_outcomes.info()
